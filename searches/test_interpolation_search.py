...
class Test_interpolation_search(unittest.TestCase):
    ...
    def test_interpolation_search(self):
        ...
        self.assertEqual(
            interpolation_search(self.collection2, self.item2),
            self.collection2.index(self.item2),
        )

        self.assertEqual(interpolation_search(self.collection3, self.item3), None)

        self.assertEqual(
            interpolation_search(self.collection4, self.item4),
            self.collection4.index(self.item4),
        )

        self.assertEqual(interpolation_search(self.collection5, self.item5), None)

        self.assertEqual(
            interpolation_search(self.collection6, self.item6),
            self.collection6.index(self.item6),
        )
    ...
    def test_interpolation_search_by_recursion(self):
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection1, self.item1, 0, len(self.collection1) - 1
            ),
            None,
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection2, self.item2, 0, len(self.collection2) - 1
            ),
            self.collection2.index(self.item2),
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection3, self.item3, 0, len(self.collection3) - 1
            ),
            None,
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection4, self.item4, 0, len(self.collection4) - 1
            ),
            self.collection4.index(self.item4),
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection5, self.item5, 0, len(self.collection5) - 1
            ),
            None,
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection6, self.item6, 0, len(self.collection6) - 1
            ),
            self.collection6.index(self.item6),
        )
        ...
        self.assertEqual(
            interpolation_search_by_recursion(
                self.collection7, self.item7, 0, len(self.collection7) - 1
            ),
            None,
        )
