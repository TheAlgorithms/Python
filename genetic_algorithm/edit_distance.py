def edit_distance(source, target):
    ...
    In genetic algorithms consisting of A,T,G,C ncleotides, this matching
    ...
    Assumptions: 
        Cost of operations insertion, deletion and subtraction is all 1
    """
    ...
    return min(edit_distance(source[:-1], target[:-1]) + delta[source[-1] == target[-1]],
