...
def next_number(n: int) -> int:
    ...
    For example if n = 12, next_number() will return 1^2 + 2^2 = 5.
...
def solution(n: int = 10000000) -> int:
    """
    The function returns the total numbers that end up in 89 after the chain generation.
    The function accepts a range n and the function checks all the values under value n,
