...
Here, we are initializing our function E_116() which holds the logic of the solution to the 
problem.The function E_116() has two parameters i = number of black coloured square tiles covered
by the new coloured (red, green or blue) tiles and k = total number of black coloured square tiles.
"""


def solution(i, k):
    """
    different ways can the grey tiles in a row measuring fifty units
...
if __name__ == "__main__":
    ...
    tiles replaced with coloured oblong tiles chosen from red(length two),
