...
def black_scholes_nondiv(S: float, K: float, T: float, r: float, sigma: float, call_value="both") -> dict:
    """
...
def black_scholes_div(S: float, K: float, T: float, r: float, q: float, sigma: float, call_value="both") -> dict:
    """
