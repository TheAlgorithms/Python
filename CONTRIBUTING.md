...
It would help us a lot in cleanup if you are mentioning your __issue number__ in your pull request, for example, adding the text: `fixes: #123` or `closes: #5678` as a comment in your pull request.
