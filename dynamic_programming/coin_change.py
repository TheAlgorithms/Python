...
def find_minimum_coins(input_coin:int, target:int) -> int:
    '''
    >>> find_minimum_coins([1, 2, 3], 4)
    2
    >>> find_minimum_coins([1, 2, 3], 7)
    3
    >>> find_minimum_coins([2, 5, 3, 6], 10)
    2
    >>> find_minimum_coins([10], 99)
    -1
    '''
    ...
    for c in input_coin:
        ...
        result = find_minimum_coins(input_coin, target - c)
