...
a = list(map(int,input("Enter the array: ").split()))     #Input of the array as list in python.

print("Maximum subarray sum is",kadane(a))                # kadane function call with the array as argument  
