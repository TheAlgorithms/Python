...
def assembly_line_scheduling(line1_entry: int, line2_entry: int, line1_stations_times: list,
    ...
    * This problem is discussed and was taken from the book "Introduction to Algorithms" by
    ...
    l_star = [] # selected stations from each assembly line in the course of optimization
    ...
    for j in range(1, len(line1_stations_times)):        
        ...
        line1_main = (f_1[j-1] + line1_stations_times[j], f_2[j-1] + line2_stations_transfer_time[j-1] + line1_stations_times[j])
        ...
        line2_main = (f_2[j-1] + line2_stations_times[j], f_1[j-1] + line1_stations_transfer_time[j-1] + line2_stations_times[j])
...
if __name__ == "__main__":
    ...
    line1_stations_transfer_time = [2,3,1,3,4]
    line2_stations_transfer_time = [2,1,2,2,1]
    doctest.testmod(extraglobs={'a': assembly_line_scheduling(line1_entry, line2_entry, line1_stations_times,
                    line2_stations_times, line1_exit, line2_exit, line1_stations_transfer_time,
