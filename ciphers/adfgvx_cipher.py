...
def main():
    ...
    mode = input("Enter e for encryption and d for decryption ").strip().lower()
...
def get_polybius_encoded_letters(key: str, letter: str) -> str:
    """
    >>> get_polybius_encoded_letters('7yvorqhkdbmp12g90n3z8tcfws6uexj4l5ai', 'a')
    'xv'
    """
...
def get_polybius_decoded_letters(key: str, letter_pair: str) -> str:
    """
    >>> get_polybius_decoded_letters('7yvorqhkdbmp12g90n3z8tcfws6uexj4l5ai', 'xv')
    'a'
    """
...
def decrypt(key: str, keyword: str, cipher: str) -> str:
    """
    >>> decrypt('7yvorqhkdbmp12g90n3z8tcfws6uexj4l5ai', 'number', 'gvgdggxxgdvv')
    'attack'
