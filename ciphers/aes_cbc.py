# make sure you have pycryptodome installed to install run "pip install pycryptodome"
...
def encrypt(text, password):
    ...
    key = PBKDF2(password, salt, dkLen=32, count=1000000, prf=lambda p, s: hmac.new(p, s, hashlib.sha256).digest())
