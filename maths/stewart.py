...
def stewart(a:float,b:float,c:float,n:float,m:float) -> float:
    ...
    Traceback (most recent call last):
        ...
    ValueError: This triangle cannot exist because of the triangle inequality
    >>> stewart(1,1,1,1,1)
    Traceback (most recent call last):
        ...
    ...
    if a+b <= c or b+c <= a or a+c <= b:
        raise ValueError("This triangle cannot exist because of the triangle inequality")
    if n+m != a:
