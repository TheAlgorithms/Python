...
def pi(precision: int) -> str:
    """
        ...
        PI = constant_term / (
            (multinomial_term * linear_term) / exponential_term
        )

        where constant_term = 426880 * sqrt(10005)

        The linear_term and the exponential_term can be defined
        ...
        This algorithm correctly calculates around 14 digits of PI
        per iteration
...
def main():
    ...
    n = 50
    PI = pi(n)
    print(f"The first {n} digits of pi is: {PI}")
