...
def collatz_sequence(n: int) -> Generator[int, None, None]:
    ...
    Traceback (most recent call last):
        ...
    Exception: Sequence only defined for positive integers
    >>> list(collatz_sequence(4))
    [4, 2, 1]
    >>> list(collatz_sequence(11))
    [11, 34, 17, 52, 26, 13, 40, 20, 10, 5, 16, 8, 4, 2, 1]
    >>> list(collatz_sequence(31))  # doctest: +NORMALIZE_WHITESPACE
    ...
    >>> list(collatz_sequence(43))  # doctest: +NORMALIZE_WHITESPACE
