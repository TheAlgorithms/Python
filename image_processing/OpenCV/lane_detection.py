...
cv2.createTrackbar('minline','hough',0,500,callback)
cv2.createTrackbar('maxgap','hough',0,500,callback)

cv2.createTrackbar('rad','rad',0,1800,callback)
cv2.createTrackbar('rad2','rad',0,1800,callback)
cv2.createTrackbar('width','rad',0,1800,callback)
...
##        #cv2.imwrite('houghlines5.jpg',gray)
    ...
    lines = cv2.HoughLines(edges, 1, np.pi / 180, 100, None, minline, maxgap)
