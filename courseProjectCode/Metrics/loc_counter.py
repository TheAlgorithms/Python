...
print("-" * dashes)
print(f"{'Category':<{col1}} {'Files':>{col2}} {'LOC':>{col3}} {'Comments':>{col3}}{'> Density %':>{col3}}")
print("-" * dashes)
...
for category, files in algorithms.items():
    ...
    category_comment_density = category_comments / category_loc if category_loc > 0 else 0
    
    print(f"{category:<{col1}} {file_count:>{col2}} {category_loc:>{col3}} {category_comments:>{col3}}{category_comment_density * 100:>{col3}.2f}")
...
print(f"{f'Total ({len(algorithms)} categories)':<{col1}} {total_files:>{col2}} {total_loc:>{col3}} {total_comments:>{col3}}{total_comment_density * 100:>{col3}.2f}\n")
...
with open(output_file, "w", encoding="utf-8", newline="") as csv_file:
    ...
    for category, files, in algorithms.items():
        for file_name, metrics in files.items():
            writer.writerow([category, file_name, metrics["loc"], metrics["comments"], metrics["comment_density"] * 100])
