...
def update(highway_now: list, PROBABILITY: int, MAX_SPEED: int) -> list:
    ...
    [-1, -1, 3, -1, -1, -1, -1, 1]
    """
    input_verification({type(highway_now): list, type(PROBABILITY)
                       : int, type(MAX_SPEED): int})
...
def simulate(highway: list, NUMBER_OF_UPDATE: int, PROBABILITY: int, MAX_SPEED: int) -> list:
    """
