def nibble_swap(byte: int) -> int:
    ...
    high_nibble = (byte & 0xF0) >> 4  # Extract the high nibble (bits 4-7) and shift it to the right
    low_nibble = (byte & 0x0F) << 4  # Extract the low nibble (bits 0-3) and shift it to the left
