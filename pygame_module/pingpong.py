...
pip install pygame
#PingPong --- The ball moves across the box as it touches the slide score gets incremented. 
If it is missed the score is decremented.
To play the game: USE "python pingpong.py in the CLI for windows from the location of the program. After saving it locally in the pc'''
