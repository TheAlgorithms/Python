# Refer https://en.wikipedia.org/wiki/Greedy_algorithm#:~:text=A%20greedy%20algorithm%20is%20any,of%20finding%20a%20global%20optimum.
...
def calc_Profit(profit: list, weight: list, max_Weight: int) -> int:
    ...
    while limit <= 15 and i < l:
        ...
        To curb this, alter the values in profit_By_Weight once they are used. Here it is done to -1 because neither profit
