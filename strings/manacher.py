def palindromic_string(input_string):
    ...
    3. return correspoding output_string by removing all "|"
    """
    max_length = 0
...
iv) a1 is corresponding equal character of a5 in palindrom with center a3 (remember that in below derivation of a4==a6)
...
Yes, look the above string we know that a5 is inside the palindrom with center a3 and previously we have
have calculated that
a0==a2 (palindrom of center a1)
a2==a4 (palindrom of center a3)
a0==a6 (palindrom of center a3)
so a4==a6

so we can say that palindrom at center a5 is at least as long as palindrom at center a1
but this only holds if a0 and a6 are inside the limits of palindrom centered at a3 so finally ..

len_of_palindrom__at(a5) = min(len_of_palindrom_at(a1), r-a5)
where a3 lies from l to r and we have to keep updating that

and if the a5 lies outside of l,r boundary we calculate length of palindrom with bruteforce and update
l,r.
