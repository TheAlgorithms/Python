...
def strip(user_string: str, characters: Optional[str] = None) -> str:
    ...
    Args:
        ...
        characters (str, optional): Optional characters to be removed (default is whitespace).
    ...
    Note:
        Right-stripping is performed after left-stripping when characters are specified.
    """
