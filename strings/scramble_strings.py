def is_scramble(s1: str, s2: str) -> bool:
    ...
    True
    """
    def split(l1: int, r1: int, l2: int, r2: int) -> bool:
        """
        Recursively check the characters in the strings to find out if s2 is a scrambled version of s1.
        >>> split(0, len("great"), 0, len("rgeat"))
        True
        """
        if r1 - l1 == 1:
            return s1[l1] == s2[l2]
