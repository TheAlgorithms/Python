def is_palindrome_slice_method(s: str) -> bool:
    """
...
def is_palindorme_iterative_method(s):
    """
    Determine if the string s is a palindrome.
...
if __name__ == "__main__":
    ...
    if is_palindrome_slice_method(s):
        print(f"'{s}' is a palindrome,by slice method.")
    else:
        print(f"'{s}' is not a palindrome.")
    if is_palindrome_iterative_method(s):
        print(f"'{s}' is a palindrome,by iterative method.")
    else:
        print(f"'{s}' is not a palindrome.")
