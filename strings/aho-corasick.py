...
class Automaton:
    ...
    def add_keyword(self, keyword):
        ...
        for character in keyword:
            if self.find_next_state(current_state, character):
                ...
                self.adlist.append({'value':character, 'next_states':[], 'fail_state':0, 'output':[]})
    ...
    def set_fail_transitions(self):
        ...
        while q:
            ...
            for child in self.adlist[r]['next_states']:
                ...
                while self.find_next_state(state, self.adlist[child]['value']) == None and state != 0:
    ...
    def search_in(self, string):
        ...
        for i in range(len(string)):
            while self.find_next_state(current_state, string[i]) == None and current_state != 0:
...
A = Automaton(keywords)
print(A.search_in('whatever, err ... , wherever'))