...
def luhn_validation(credit_card_number: str) -> bool:
    ...
    for i in range(half_len,-1,-2):
        ...
        digit *= 2
        # If doubling of a number results in a two digit number i.e greater than 9(e.g., 6 × 2 = 12), 
...
def validate_credit_card_number(number: str):
    ...
    if credit_card_number.isdigit():
        ...
        print(f"Invalid number({number}) given: Contains alphabets or special charecters")
