...
def createRopeStructure(node, par, a, l, r):  # Define a function to create a rope structure
    ...
    if (r-l) > LEAF_LEN:  # If the length of the substring is greater than LEAF_LEN
        ...
        createRopeStructure(node.left, node, a, l, m)  # Recursively create the left subtree
        createRopeStructure(node.right, node, a, m+1, r)  # Recursively create the right subtree
    else:
...
def concatenate(root3, root1, root2, n1):  # Define a function to efficiently concatenate two strings
...
root1 = createRopeStructure(root1, None, a, 0, n1-1)  # Create a rope structure for string 'a'
...
root2 = createRopeStructure(root2, None, b, 0, n2-1)  # Create a rope structure for string 'b'
