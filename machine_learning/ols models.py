...
# Model Training
 ...
 # But these parameters have not been set in our model
 # We need to train our model (fit) to find these values 
 # so the model can reliably estimate boot sizes based on their harness sizes
