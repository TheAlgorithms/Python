...
from sklearn.metrics import (  # The plot_confusion_matrix method will be deprecated in the developed versions of Python 3.10.x according to the warning that it throws when this code is run.
    accuracy_score,
    confusion_matrix,
)
