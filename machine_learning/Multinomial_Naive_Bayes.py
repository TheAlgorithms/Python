...
def main()-> None:
    ...
    X_train,X_test,y_train,y_test = train_test_split(iris[X],iris[Y],test_size=0.3, random_state=0)
    ...
    print(f"Cross Val Accuracy:\t {np.mean(cross_val_score(MNB, X_train, y_train.values.ravel(), cv=10)) }")
