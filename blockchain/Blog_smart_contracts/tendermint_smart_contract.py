...
from abci import ResponseInfo, ResponseInitChain, ResponseCheckTx, ResponseDeliverTx, ResponseQuery, ResponseCommit, ResponseEndBlock, ResponseBeginBlock

# Define the custom application
class BlogApplication(BaseApplication):
    def info(self, req) -> ResponseInfo:
        return ResponseInfo(data="Python Tendermint ABCI Blog Application", version="1.0", last_block_height=0, last_block_app_hash=b'')
