...
contract = Contract(account, 'blog_contract', 'blog.wasm', setup, 'Your NEAR Access Key')

# Access the contract functions
init_blog = contract.init_blog('your_authority_account_id')
signup_user = contract.signup_user('your_authority_account_id', 'John Doe', 'avatar.png')
create_post = contract.create_post('your_authority_account_id', 'First Post', 'Hello World!', 'user_id')
