...
if __name__ == "__main__":
    ...
    print(f"Pressure(P) of a gas system with V = {example_1_volume} [m^3], n = {example_1_moles} [mol], T = {example_1_kelvin} [K]:")
    print(f"{pressure_of_gas_system(example_1_moles, example_1_kelvin, example_1_volume)} [Pa]")
    ...
    print(f"Volume(V) of a gas system with P = {example_2_pressure} [Pa], n = {example_2_moles} [mol], T = {example_2_kelvin} [K]:")
    print(f"{volume_of_gas_system(example_2_moles, example_2_kelvin, example_2_pressure)} [m^3]")
