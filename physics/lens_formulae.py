"""
    ...
    image from the lens and
    distance of object from the lens.
    The above is calculated uding the lens formula.
    ...
    for mathematical analysis of image formation. According to it:
        ...
        https://testbook.com/physics/derivation-of-lens-maker-formula#:~:text=Assumptions%20of%20Lens%20Maker%27s%20Formula&text=The%20object%20O%20is%20a,of%20refraction%20should%20be%20small.)
...
def object_distance(focal_length_of_lens: float, image_distance_from_lens: float):
    """
    Doctests:
    >>> from math import isclose
...
def image_distance(focal_length_of_lens: float, object_distance_from_lens: float):
    """
    Doctests:
    >>> from math import isclose
...
print(focal_length_of_lens(50, 40))
