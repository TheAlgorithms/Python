...
def calculate_escape_velocity(
    ...
    """
    Calculate the escape velocity required for an object to leave the gravitational influence of a celestial body.
    ...
    - distance_from_center (float): Distance from the center of the celestial body in meters.
