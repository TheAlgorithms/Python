...
if __name__ == "__main__":
    ...
    if f == "U":
        print(
            "Enter Initital State of the Puzzle(Space Seperated Value (N*N):  ", sep=""
        )
        Puzzle = []
    ...
    if isPossible(Puzzle):
        ...
        if stepInBFS < stepInDFS:
            print(
                "BFS algorithm Performs Better than DFS algorithm for this given Puzzle."
            )
        elif stepInBFS > stepInDFS:
            print(
                "DFS algorithm Performs Better than BFS algorithm for this given Puzzle."
            )
        else:
            print(
                "Both BFS and DFS algorithm solves the given Puzzle in equivalent time."
            )
        print(
            "*************Thank You So Much For Using Our Application*******************"
        )
    # Unsolvable
    else:
