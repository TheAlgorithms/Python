...
class LinkedList:
	...
	def add_at_begin(self,data)->None: #adds the given element as the head in the Linked List
		new_node=Node(data)
		new_node.ref=self.__head
		self.__head=new_node
		self.__size+=1

	def del_from_beg(self)->None: #deletes the head of the Linked List
	...
	def add_at_end(self,data)->None: #adds the given element as the tail in the Linked List
		if self.is_empty():
	...
	def del_at_end(self)->None: #deletes the tail of the Linked List
		if self.is_empty():
			print("Can't delete elements, LL is empty.")
	...
	def add_after_node(self,data,given_node)->None: #adds a node with the provided data just after the given node
	...
	def del_after_node(self,given_node)->None: #deletes a node just after the given node
	...
	def add_before_node(self,data,given_node)->None: #adds a node with the provided data just before the given node
	...
	def del_before_node(self,given_node)->None: #deletes a node with the provided data just before the given node
	...
	def del_by_value(self,given_node)->None: #deletes teh node whose data has been provided
