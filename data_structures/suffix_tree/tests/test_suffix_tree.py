...
class TestSuffixTree(unittest.TestCase):
    ...
    def test_search_existing_patterns(self) -> None:
        ...
        for pattern in patterns:
            with self.subTest(pattern = pattern):
                assert self.suffix_tree.search(pattern), f"Pattern '{pattern}' should be found."
    ...
    def test_search_non_existing_patterns(self) -> None:
        ...
        for pattern in patterns:
            with self.subTest(pattern = pattern):
                assert not self.suffix_tree.search(pattern), f"Pattern '{pattern}' should not be found."
    ...
    def test_search_full_text(self) -> None:
        ...
        assert self.suffix_tree.search(self.text), "The full text should be found in the suffix tree."
    ...
    def test_search_substrings(self) -> None:
        ...
        for substring in substrings:
            with self.subTest(substring=substring):
                assert self.suffix_tree.search(substring), f"Substring '{substring}' should be found."
