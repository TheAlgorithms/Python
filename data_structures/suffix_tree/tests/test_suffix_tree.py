...
class TestSuffixTree(unittest.TestCase):
    ...
    def test_search_existing_patterns(self):
        ...
        for pattern in patterns:
            with self.subTest(pattern=pattern):
                self.assertTrue(
                    self.suffix_tree.search(pattern),
    ...
    def test_search_empty_pattern(self):
        ...
        self.assertTrue(
            self.suffix_tree.search(""), "An empty pattern should be found."
        )

    def test_search_full_text(self):
        """Test searching for the full text."""
        self.assertTrue(
            self.suffix_tree.search(self.text),
    ...
    def test_search_substrings(self):
        ...
        for substring in substrings:
            with self.subTest(substring=substring):
                self.assertTrue(
                    self.suffix_tree.search(substring),
