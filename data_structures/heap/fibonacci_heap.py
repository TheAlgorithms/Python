...
class FibonacciHeap:
    ...
    def insert(self, key):
        ...
        if self.min_node is None:
            ...
            # Insert the new node into the root list and update the minimum node if necessary
    ...
    def _link(self, child, parent):
        """
        Link two nodes in the Fibonacci Heap. The node with the smaller key becomes the child of the other.
