...
class StringMatch():
    def __init__(self, function_method_name='Z_FUNCTION', separator='\uFFFF'):
        ...
        Args:
            function_method_name (str): The string matching algorithm to use ('Z_FUNCTION' or 'PI_FUNCTION').
        ...
        if function_method_name in self.__function_dictionary.keys():
    ...
    def match(self, text: str, pattern: str):
        ...
        occurrence_count, occurrence_indices = self.Function(
    ...
    def __zfun_match(self, text: str, pattern: str):
        ...
        Returns:
            tuple: A tuple containing the occurrence count and occurrence indices.
        """
        merged_string = self.__merge_text_and_pattern(
            text=text, pattern=pattern)
    ...
    def __z_function(self, merged_string: str):
        ...
        Args:
            merged_string (str): The string for which Z-function values are to be calculated.
    ...
    def __pi_function(self, merged_string: str):
        ...
        Args:
            merged_string (str): The string for which Pi-function values are to be calculated.
...
1. Create Object Of the Class StringMatch with custom function_method_selection and separator
