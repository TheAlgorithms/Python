...
def test_stack():
   ...
   n=int(input("1 to push 2 to pop and 3 to peek 4 to print  and 5 for size of the stack and 6 to exit:"))
   while (n in (1, 2, 3, 4, 5, 6)):
       ...
       n=int(input("1 to push 2 to pop and 3 to peek 4 to print  and 5 for of the stack and 6 to exit:"))
