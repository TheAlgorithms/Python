...
def fdh(string, n=256):
    '''full domain hash of 'string' using SHA256 with digest of n-1 bits. Generates a hash with an arbitrary bit size given as input (n)
       The function generates a hash digest of bitsize = n bits.   
       This is achieved by repeatedly appending an incremental value at the end of input string and calculation of SHA256 hash. These hash digests are concatenated to generate hash of desired bit size'''
