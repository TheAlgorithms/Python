...
at a general speed but when a resistor is connected in the  ciruit with in series to
a capacitor then the capacitor charges slowly means it will take more time than usuall.
...
initation of charging a capacitor with the help of the exponential function
containg RC.Both at charging and discharging of a capacitor.
"""
...
def charging_capacitor(
    ...
    time_sec: float,  # time in seconds after charging initation of capacitor.
) -> float:
    """
    find voltage of capacitor at any nth second after the initation of it's charging.
    ...
    capacitance : float
        it is multiplying with resistance_ohms to yeild output.
    time_sec : float
