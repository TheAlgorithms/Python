...
def dijkstra_with_potential(graph: Dict[int, List[Tuple[int, int]]],
                           source: int,
                           n: int,
                           potential: List[float]) -> List[float]:
    """
...
def johnsons_algorithm(graph: Dict[int, List[Tuple[int, int]]], 
