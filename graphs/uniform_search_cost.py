...
def uniform_search_cost(
    ...
    >>> graph_data = [[1, 2], [2, 3], [], [0, 2]]
    >>> distance = {(0,1):2.91,(0,2):1.1,(1,2):3,(1,3):2.3,(3,0):2.34,(3,2):2.15}
    >>> goal = [2]
    >>> start = 0
    >>> uniform_search_cost(graph_data, distance, goal, start)
    [1.1]
    ...
    >>> graph_data = [[1, 2], [2, 3], [], [0, 2]]
    >>> distance = {(0,1):2.91,(0,2):0,(1,2):3,(1,3):2.3,(3,0):2.34,(3,2):2.15}
    >>> goal = [2]
    >>> start = 0
    >>> uniform_search_cost(graph_data, distance, goal, start)
    [0]
    ...
    >>> graph_data = [[1, 2], [2, 3], [], [0, 2]]
    >>> distance = {(0,1):1.3,(0,2):2.6,(1,2):0,(1,3):2.3,(3,0):2.34,(3,2):2.15}
    >>> goal = [2]
    >>> start = 0
    >>> uniform_search_cost(graph_data, distance, goal, start)
    [1.3]
...
def run() -> None:
    ...
    >>> run()
    start: 0, goal: 6; Distance(Minimum/Lowest): 11
    """
    # create the graph
    #
    #
