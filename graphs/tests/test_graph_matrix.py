...
sys.path.append("..")
from graph_matrix import GraphAdjacencyMatrix
...
class TestGraphMatrix(unittest.TestCase):
    ...
    def test_contains_vertex(self):
        ...
        undirected_graph = GraphAdjacencyMatrix(
            vertices=random_vertices, directed=False
        )
        directed_graph = GraphAdjacencyMatrix(vertices=random_vertices, directed=True)
    ...
    def test_add_vertices(self):
        ...
        # build empty graphs
        undirected_graph = GraphAdjacencyMatrix(directed=False)
        directed_graph = GraphAdjacencyMatrix(directed=True)
    ...
    def test_add_and_remove_vertices_repeatedly(self):
        ...
        # build graphs WITHOUT edges
        undirected_graph = GraphAdjacencyMatrix(
            vertices=random_vertices1, directed=False
        )
        directed_graph = GraphAdjacencyMatrix(vertices=random_vertices1, directed=True)
