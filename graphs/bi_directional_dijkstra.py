...
def bidirectional_dij(source: str, destination: str, graph_forward: dict, graph_backward: dict) -> int:
    ...
    while queue_forward and queue_backward:
        ...
        for next_forward, d_forward in graph_forward[vertex_forward]:
            ...
            if next_forward in visited_backward:
                if cost_forward[vertex_forward] + d_forward + cost_backward[next_forward] < shortest_distance:
        ...
        for next_backward, d_backward in graph_backward[vertex_backward]:
            ...
            if next_backward in visited_forward:
                if cost_backward[vertex_backward] + d_backward + cost_forward[next_backward] < shortest_distance:
