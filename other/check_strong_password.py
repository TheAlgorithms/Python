# Functions to Check Whether A Given Password Is Strong Or Not
...
def is_strong_password_2(password: str, min_length: int = 8) -> bool:
    ...
    False
    """
    # Initialise boolean flags which toggle when the first occurence of a
    # type is encountered
    ...
    # Toggle respective flags when you encounter a charcter type
